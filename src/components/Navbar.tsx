...
function Navbar() {
  ...
  return (
    <nav className='flex flex-direction-row justify-around align-middle bg-[#EAE2B7] border-solid border-2 border-black rounded-md px-6 py-4 sticky top-0 w-full z-10'>
